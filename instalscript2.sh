...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/TDMods/VPS-MX-PRO/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default-si.conf -O /usr/local/vpsmxup/vpsmxup.default.conf  &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf 
	rm -rf /usr/local/vpsmxup/vpsmxup.sh
    wget https://raw.githubusercontent.com/TDMods/VPS-MX-PRO/main/VPS-MX_Oficial/zzupdate-master/zzupdate.default.conf -O /usr/local/vpsmxup/vpsmxup.default.conf &> /dev/null
	chmod +x /usr/local/vpsmxup/vpsmxup.default.conf
	rm -rf /root/VPS-MX
    wget https://raw.githubusercontent.com/TDMods/VPS-MX-PRO/main/VPS-MX2 -O /root/VPS-MX &> /dev/null
	chmod +x /root/VPS-MX
